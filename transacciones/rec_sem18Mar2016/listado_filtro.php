			...
			<div class="panel-body">
				 <form role="form">
				    <div class="form-group form-group-sm">
					    ...
					    <div class="row">
					    	<div class="col-xs-2"><?php $crearcampo->Label($Arrfiltro_idrecepcion);   	$crearcampo->CrearInputText($Arrfiltro_idrecepcion);   	?></div>					    
							<div class="col-xs-2"><?php $crearcampo->Label($Arrfiltro_fecha);        	$crearcampo->CrearInputText($Arrfiltro_fecha);         	?></div>
					    	<div class="col-xs-6"><?php $crearcampo->Label($Arr_clientes);	    		$crearcampo->Combobox($Arr_clientes);            		?></div>
